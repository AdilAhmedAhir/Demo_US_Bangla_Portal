...
const notices: Notice[] = [
  ...
  },
  {
    ...
    excerpt: 'The deadline for tuition fee payment for the current academic term has been extended to April 30, 2026. Students with outstanding dues will not be eligible for appearing in the upcoming examinations.',
